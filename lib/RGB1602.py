...
#Device I2C Arress
#LCD_ADDRESS   =  (0x7c>>1) # Orginal Address
#RGB_ADDRESS   =  (0xc0>>1) # Orginal Address
LCD_ADDRESS   =  (0x3e) # Address from Scan
RGB_ADDRESS   =  (0x60) # Address from Scan
...
class RGB1602:
  def __init__(self, col, row, RGB1602_I2C=None):
    self._row = row
    self._col = col
    if RGB1602_I2C is None:
        raise ValueError('An I2C object is required.')
    self.RGB1602_I2C = RGB1602_I2C
